/* BioDynaMit v11.2.3 — inventory-centric navigation and UI consistency.
...
(function(){
  ...
  if(baseDetail){
    antibodyDetail=function(){
      ...
      topbar('Anticorps primaires',primaryActions('detail'));
      bindPrimaryTabs();
      return result;
    };
  }
  ...
  function wrapPrimaryStorage(fn){
    ...
    return function(){
      ...
      topbar('Anticorps primaires',primaryActions('storage'));
      bindPrimaryTabs();
      return result;
    };
  }
  ...
  try{renderNav();}catch(err){console.warn('v11.2.3 navigation:',err);}
})();